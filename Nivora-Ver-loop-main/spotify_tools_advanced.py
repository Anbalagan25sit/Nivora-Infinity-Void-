...
async def spotify_play_track(
    ...
    try:
        ...
        if response.status_code in (200, 204):
            ...
            return "No active Spotify device found. Please open Spotify and play any song first to activate a device."
...
async def spotify_play_album(
    ...
    try:
        ...
        if response.status_code in (200, 204):
            ...
            return "No active device. Open Spotify and play something first."
        else:
