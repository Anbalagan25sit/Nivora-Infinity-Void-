...
import { Mic, Brain, Workflow, Zap } from 'lucide-react';

export function ArchitectureSection() {
  return (
    <section id="how-it-works" className="relative py-32 bg-gradient-to-b from-[#0a0a0a] to-black overflow-hidden">
      {/* Background Glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] rounded-full bg-gradient-to-r from-purple-600/10 to-blue-600/10 blur-[150px]" />
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="max-w-6xl mx-auto mb-24">
          <svg viewBox="0 0 1200 400" className="w-full h-auto">
            ...
            <motion.path
              ...
              initial={{ pathLength: 0 }}
              animate={{ pathLength: 1 }}
              transition={{ duration: 1, delay: 1, repeat: Infinity, repeatDelay: 3, ease: 'easeInOut' }}
            />
            <motion.path
            ...
            <motion.path
              ...
              initial={{ pathLength: 0 }}
              animate={{ pathLength: 1 }}
              transition={{ duration: 1, delay: 2, repeat: Infinity, repeatDelay: 3, ease: 'easeInOut' }}
            />
            <motion.path
            ...
            <g>
              ...
              <text x="1075" y="205" textAnchor="middle" fill="white" fontSize="14" fontWeight="600">
                ⚡ Actions
              </text>
            </g>
          </svg>
        ...
        >
          <div className="text-center p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
            ...
            <div className="text-gray-400 text-sm uppercase tracking-wider">Voice latency</div>
          </div>
          ...
          <div className="text-center p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
            ...
            <div className="text-gray-400 text-sm uppercase tracking-wider">n8n integrations</div>
          </div>
          ...
          <div className="text-center p-8 rounded-2xl bg-white/5 border border-white/10 backdrop-blur-sm">
            ...
            <div className="text-gray-400 text-sm uppercase tracking-wider">Local by default</div>
          </div>
        </motion.div>
      </div>
    </section>
