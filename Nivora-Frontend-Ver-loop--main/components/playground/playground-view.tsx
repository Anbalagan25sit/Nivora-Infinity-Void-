...
export function PlaygroundView() {
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center">
      {/* Header */}
      <header className="absolute left-0 right-0 top-0 z-10 flex items-center justify-between border-b border-border/40 bg-background/80 px-6 py-4 backdrop-blur-sm">
        <div className="flex items-center gap-3">
          <div className="flex h-8 w-8 items-center justify-center rounded-full bg-primary/10">
            <span className="text-sm font-bold text-primary">LK</span>
          </div>
      ...
      <div className="flex h-full w-full flex-col items-center justify-center pt-20 pb-32">
        ...
        <div className="flex flex-col items-center justify-center gap-8">
          ...
          <AgentStateIndicator messages={messages} />
        ...
        <AnimatePresence>
          {chatOpen && (
            <MotionDiv
              ...
              className="absolute right-0 top-0 z-20 h-full w-96 border-l border-border bg-background/95 backdrop-blur-sm"
            >
              <TranscriptPanel
                messages={messages}
      ...
      <div className="absolute bottom-8 left-1/2 z-30 -translate-x-1/2">
        <div className="flex items-center gap-3 rounded-full border border-border/40 bg-background/80 px-6 py-3 shadow-lg backdrop-blur-sm">
          <AgentControlBar
            variant="livekit"
            controls={{
              microphone: true,
...
function WelcomeScreen({ onConnect }: { onConnect: () => void }) {
  ...
  return (
    <div className="relative flex h-full w-full flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center gap-4 px-6 pb-32">
        ...
        >
          ...
          <motion.img
            ...
            alt="Nivora Logo"
            className="w-32 h-32 md:w-40 md:h-40 rounded-full object-cover relative z-10"
            style={{
          ...
          />
          {/* Pulse rings */}
          <div className="absolute inset-[-8px] rounded-full border border-cyan-400/20 animate-ping" style={{ animationDuration: '3s' }} />
          <div className="absolute inset-[-20px] rounded-full border border-purple-400/10 animate-ping" style={{ animationDuration: '3s', animationDelay: '1.5s' }} />
        </motion.div>
        ...
        >
          <h1
            className="aurora-text text-4xl md:text-5xl lg:text-6xl font-light tracking-tight"
            style={{
        ...
        <motion.p
          ...
          className="text-sm md:text-base text-cyan-300/60 font-light min-h-[24px]"
          style={{ fontFamily: "'Inter', sans-serif" }}
        >
          {typedText}<span className="text-cyan-400 animate-pulse">|</span>
        </motion.p>
        ...
        <motion.p
          ...
          className="text-sm md:text-base tracking-[0.25em] text-white/40 uppercase font-medium"
        >
          ...
          >
            ...
            >
              <span
                ...
                style={{
                  background: 'linear-gradient(90deg, #ffffff 0%, #e0f7ff 25%, #ffffff 50%, #b3ecff 75%, #ffffff 100%)',
      ...
      >
        <p className="text-center text-xs tracking-[0.15em] text-white/30 uppercase mb-4" style={{ fontFamily: "'Inter', sans-serif" }}>
            ...
            {AI_MODEL_LOGOS.map((model, idx) => (
              ...
              >
                <img
                  src={model.logo}
                  alt={model.name}
                  className="h-7 w-auto opacity-40 hover:opacity-100 transition-all duration-300"
...
// Agent State Indicator
function AgentStateIndicator({ messages }: { messages: any[] }) {
  const lastMessage = messages[messages.length - 1];
  const isAgentSpeaking = lastMessage?.from?.isLocal === false;
