...
function AgentChatInput({ chatOpen, onSend = async () => { }, className }: AgentChatInputProps) {
  ...
  return (
    <div className={cn('flex grow items-end gap-2 rounded-md px-2 py-1 text-sm bg-transparent', className)}>
      <textarea
        autoFocus
        ref={inputRef}
        value={message}
        ...
        className="field-sizing-content max-h-16 min-h-8 flex-1 resize-none py-1 bg-transparent [scrollbar-width:thin] focus:outline-none disabled:cursor-not-allowed disabled:opacity-50"
      />
      <Button
        size="icon"
        type="button"
...
export function AgentControlBar({
  ...
  return (
    ...
    >
      ...
      >
        <div className="gemini-input-glow w-full mb-3">
          <AgentChatInput
